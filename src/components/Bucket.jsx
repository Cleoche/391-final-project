...
import { useGLTF } from '@react-three/drei'; // automatic import for .gltf integration
...
<group {...props} dispose={null} ref={ref}>                  {/*_ref_ attribute animates the model as a whole*/}
    {/*color attribute passed as prop to allow for Paige's component to change it*/}
      <mesh geometry={nodes.Bucket_low_Bucket_low_0.geometry}>
          <meshStandardMaterial color={props.color}/>        {/*Removed texture from model and replaced with default*/}
      </mesh>
